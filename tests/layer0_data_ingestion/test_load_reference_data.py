...
class TestLoadGeographicAreas:
    ...
    def test_load_all_geographic_areas(self, db_session):
        ...
        from src.layer0_data_ingestion.load_reference_data import load_geographic_areas
    ...
    def test_countries_loaded(self, db_session):
        ...
        assert countries == 5, f"Expected 5 countries (UK + 4 nations), got {countries}"
...
class TestLoadAgeCohorts:
    ...
    def test_load_all_cohorts(self, db_session):
        ...
        from src.layer0_data_ingestion.load_reference_data import load_age_cohorts
...
class TestLoadFinancialYears:
    ...
    def test_load_all_years(self, db_session):
        ...
        from src.layer0_data_ingestion.load_reference_data import load_financial_years
